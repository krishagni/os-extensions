{ 
  ...
  "settings":{ 
    ...
    "staging_importer":{ 
      "title":"Staging Participant Importer",
      "stg_imp_db_url":"Database URL",
      "stg_imp_db_url_desc":"Database URL which connects to the external DB",
      "stg_imp_db_user":"Database username",
      "stg_imp_db_user_desc":"External database username",
      "stg_imp_db_pwd":"Database password",
      "stg_imp_db_pwd_desc":"External database password",
      "stg_imp_json_mapping":"JSON mapping file",
      "stg_imp_json_mapping_desc":"Path for the JSON mapping file that contains the SQL and source name for the external DB"
    }
  },
  "dp":{ 
    "irb_id":"IRB #",
